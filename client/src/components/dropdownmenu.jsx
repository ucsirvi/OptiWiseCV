...
const baseItemStyles =
  "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:bg-accent focus:bg-accent";
const baseSubTriggerStyles =
...
const DropdownMenuSubTrigger = React.forwardRef(
  ({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
      ref={ref}
      className={cn(baseSubTriggerStyles, inset && "pl-8", className)}
      {...props}
    >
      {children}
...
const DropdownMenuItem = React.forwardRef(
  ({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
      ref={ref}
      className={cn(baseItemStyles, inset && "pl-8", className)}
      {...props}
    />
  )
);
...
const DropdownMenuCheckboxItem = React.forwardRef(
  ({ className, children, checked, ...props }, ref) => (
    <DropdownMenuPrimitive.CheckboxItem
      ref={ref}
      className={cn(baseItemStyles, "py-1.5 pl-8 pr-2", className)}
      checked={checked}
      {...props}
    >
